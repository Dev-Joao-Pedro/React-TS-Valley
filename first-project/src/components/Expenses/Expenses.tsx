...
const Expenses = ({ emitMovement, currentExpenses, currentBalance }: ExpensesProps) => {
  ...
  return (
    <>
      <div className='expenses-container'>
        ...
        <h3>{ currentExpenses > 0 ? `R$ ${currentExpenses}` : 'R$ 0.00' }</h3>
            
            {!renderInputForm && (
                <Button action={ handleRenderInputForm } title={'Saida'} priority='Output' disable={currentBalance === 0} />
            )}
